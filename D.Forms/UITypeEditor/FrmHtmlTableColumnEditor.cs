...
namespace D.Forms
{
    public partial class FrmHtmlTableColumnEditor<T> : Form where T : MHtmlTableColumn, new()
    {
        public FrmHtmlTableColumnEditor(object value)
        {
            InitializeComponent();

            this.value = value as List<T>;
            this.Bind();
        }
        ...
        public List<T> Value { get { return this.value; } }
