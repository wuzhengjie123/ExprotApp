...
namespace D.Forms
{
    ...
    public partial class MSideBarMenu : MBorderControl
    {
        ...
        /// 单击事件
        /// </summary>
        [Browsable(true), Category("D"), Description("当前选中事件")]
        internal event Action<MSideBarMenu> OnSelected;

        /// <summary>
        /// 获取或设置标题颜色
        /// </summary>
        [Browsable(true), Category("D"), Description("标题")]
        public string Title
        {
            get
            {
        ...
        /// 是否当前项
        /// </summary>
        [Browsable(true), Category("D"), Description("是否当前项")]
        ...
        /// 获取或设置图片
        /// </summary>
        [Browsable(true), Category("D"), Description("图片")]
        public Image Image
        {
            get { return image; }
            set
        ...
        /// 单击事件
        /// </summary>
        [Browsable(true), Category("D"), Description("单击事件")]
