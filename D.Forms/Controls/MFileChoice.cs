...
namespace D.Forms.Controls
{
    public partial class MFileChoice : UserControl
    {
        ...
        [Browsable(true), Category("D"), Description("指示对话框是否允许选择多个文件"), DefaultValue("")]
        public string Filter { get; set; }

        [Browsable(true), Category("D"), Description("包含在文件对话框中选定的文件名的字符串"), DefaultValue("")]
        ...
        [Browsable(true), Category("D"), Description("文件对话框显示的初始目录"), DefaultValue("")]
        public string InitialDirectory { get; set; }

        [Browsable(true), Category("D"), Description("文件对话框标题"), DefaultValue("")]
