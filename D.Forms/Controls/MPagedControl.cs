...
namespace D.Forms
{
    public partial class MPagedControl : UserControl
    {
        ...
        [Browsable(true), Description("可用的上翻页按钮图片"), Category("D")]
        public Image PreviousImage { get; set; }

        [Browsable(true), Description("可用的首页按钮图片"), Category("D")]
        public Image FirstImage { get; set; }

        [Browsable(true), Description("可用的下翻页按钮图片"), Category("D")]
        public Image NextImage { get; set; }

        [Browsable(true), Description("可用的尾页按钮图片"), Category("D")]
        public Image LastImage { get; set; }

        [Browsable(true), Description("不可用的上翻页按钮图片"), Category("D")]
        public Image PreviousDisableImage { get; set; }

        [Browsable(true), Description("不可用的首页按钮图片"), Category("D")]
        public Image FirstDisableImage { get; set; }

        [Browsable(true), Description("不可用的下翻页按钮图片"), Category("D")]
        public Image NextDisableImage { get; set; }

        [Browsable(true), Description("不可用的尾页按钮图片"), Category("D")]
        public Image LastDisableImage { get; set; }

        [Browsable(true), Description("当前页变更事件"), Category("D")]
