...
namespace D.Forms
{
    public class MRadioButton : Control, IButtonControl
    {
        ...
        [Category("D"), Description("选中属性变更事件"), DefaultValue(false)]
        ...
        [Category("D"), Description("圆圈大小"), DefaultValue(22)]
        public int EllipseSize { get { return this.ellipseSize; } set { this.ellipseSize = value; this.Invalidate(); } }

        private bool isChecked;
        [Category("D"), Description("是否选中"), DefaultValue(false)]
        public bool Checked { get { return this.isChecked; } set { this.isChecked = value; this.Invalidate(); } }

        [Category("D"), Description("默认状态外环颜色"), DefaultValue(typeof(Color), "244, 130, 8")]
        public Color DefaultOutLineColor { get; set; }

        [Category("D"), Description("激活/选中状态圆点颜色"), DefaultValue(typeof(Color), "244, 130, 8")]
        public Color ActivedPointColor { get; set; }

        [Category("D"), Description("激活/选中状态外环颜色"), DefaultValue(typeof(Color), "244, 130, 8")]
        public Color ActivedOutLineColor { get; set; }

        [Category("D"), Description("不可用状态圆点颜色"), DefaultValue(typeof(Color), "244, 130, 8")]
        public Color DisablePointColor { get; set; }

        [Category("D"), Description("不可用状态外环颜色"), DefaultValue(typeof(Color), "244, 130, 8")]
