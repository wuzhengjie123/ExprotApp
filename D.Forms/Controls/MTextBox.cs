...
namespace D.Forms
{
    public partial class MTextBox : UserControl
    {
        ...
        /// 获取或设置文本最大长度
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置文本最大长度")]
        ...
        /// 获取或设置只读
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置只读")]
        ...
        /// 获取或设置标题
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置标题")]
        public string Title
        {
        ...
        /// 获取或设置文本
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置文本")]
        ...
        /// 获取或设置是否使用系统密码
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置是否使用系统密码")]
        ...
        /// 获取或设置密码字符
        /// </summary>
        [Browsable(true), Category("D"), Description("获取或设置密码字符")]
