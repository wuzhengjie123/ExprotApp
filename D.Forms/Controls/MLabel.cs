...
namespace D.Forms
{
    public sealed class MLabel : Control
    {
        ...
        [Browsable(true), Category("D"), Description("边框定义")]
        ...
        [Browsable(true), Category("D"), Description("背景色")]
        ...
        [Browsable(true), Category("D"), Description("自动改变大小")]
        ...
        [Browsable(true), Category("D"), Description("文字对齐方式")]
        public TextAlignment Align { get { return align; } set { align = value; this.Invalidate(); } }

        private string text;
        [Browsable(true), Category("D"), Description("文字内容")]
