...
namespace D.Forms
{
    ...
    public class MCaptionPanel : MPanel
    {
        ...
        [Category("D"), Description("标题栏高度"), DefaultValue(40)]
        ...
        [Category("D"), Description("标题栏背景色"), DefaultValue(typeof(Color), "#2ecc71")]
        public Color CaptionBackColor { get; set; }

        [Category("D"), Description("标题栏背景渐变色"), DefaultValue(typeof(Color), "27ae60")]
        public Color CaptionBackColorGradint { get; set; }

        [Browsable(true), Category("D"), Description("背景颜色渐变方向"), DefaultValue(typeof(GradientMode), "Horizontal")]
        public GradientMode CaptionLinearGradientMode { get; set; }

        private Color captionForeColor;
        [Category("D"), Description("标题栏文字颜色"), DefaultValue(typeof(Color), "White")]
