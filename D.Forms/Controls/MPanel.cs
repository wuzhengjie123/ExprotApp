...
namespace D.Forms
{
    ...
    public class MPanel : Panel
    {
        ...
        [Category("D"), Description("边框样式"), DefaultValue(typeof(ButtonBorderStyle), "Solid")]
        public new ButtonBorderStyle BorderStyle { get { return this.borderStyle; } set { this.borderStyle = value;this.Invalidate(); } }

        [Category("D"), Description("默认背景色"), DefaultValue(typeof(Color), "Transparent")]
        public new Color BackColor { get; set; }

        [Category("D"), Description("默认背景渐变色"), DefaultValue(typeof(Color), "Empty")]
        public Color BackColorGradint { get; set; }

        [Browsable(true), Category("D"), Description("背景颜色渐变方向"), DefaultValue(typeof(GradientMode), "None")]
        public GradientMode LinearGradientMode { get; set; }

        private RadiusMode radiusMode;
        [Category("D"), Description("圆角模式"), DefaultValue(typeof(RadiusMode), "None")]
        public RadiusMode RadiusMode { get { return this.radiusMode; } set { this.radiusMode = value; this.SetPadding(); } }

        private int radius;
        [Category("D"), Description("圆角大小，将覆盖L、T、R、B"), DefaultValue(0)]
        public int Radius { get { return this.radius; } set { this.radius = value; this.SetPadding(); } }

        private Color borderColor;
        [Category("D"), Description("边框颜色，将覆盖L、T、R、B"), DefaultValue(typeof(Color), "Empty")]
        ...
        [Category("D"), Description("边框大小"), DefaultValue(0)]
        ...
        [Category("D"), Description("左边框颜色，圆角模式无效"), DefaultValue(typeof(Color), "Empty")]
        ...
        [Category("D"), Description("左边框大小，圆角模式无效"), DefaultValue(0)]
        ...
        [Category("D"), Description("右边框颜色，圆角模式无效"), DefaultValue(typeof(Color), "Empty")]
        ...
        [Category("D"), Description("右边框大小，圆角模式无效"), DefaultValue(0)]
        ...
        [Category("D"), Description("上边框颜色，圆角模式无效"), DefaultValue(typeof(Color), "Empty")]
        ...
        [Category("D"), Description("上边框大小，圆角模式无效"), DefaultValue(0)]
        ...
        [Category("D"), Description("下边框颜色，圆角模式无效"), DefaultValue(typeof(Color), "Empty")]
        ...
        [Category("D"), Description("下边框大小，圆角模式无效"), DefaultValue(0)]
