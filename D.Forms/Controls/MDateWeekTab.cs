...
namespace D.Forms.Controls
{
    ...
    public sealed class MDateWeekTab : Control
    {
        ...
        [Browsable(true), Description("日期改变事件"), Category("D")]
        public event EventHandler DateChanged;

        private DateTime date;

        [Browsable(true), Category("D"), Description("当前日期")]
        ...
        [Browsable(true), Description("分割线大小"), Category("D")]
        ...
        [Browsable(true), Description("下划线大小"), Category("D")]
        ...
        [Browsable(true), Description("分割线颜色"), Category("D")]
        ...
        [Browsable(true), Description("下划线颜色"), Category("D")]
        ...
        [Browsable(true), Description("非激活状态颜色"), Category("D")]
        ...
        [Browsable(true), Description("激活状态颜色"), Category("D")]
        ...
        [Browsable(true), Description("最小日期"), Category("D")]
        ...
        [Browsable(true), Description("最大日期"), Category("D")]
