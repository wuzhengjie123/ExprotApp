...
namespace D.Forms.Controls
{
    public partial class MPathChoice : UserControl
    {
        ...
        [Browsable(true), Category("D"), Description("用户选定的路径"), DefaultValue("")]
        ...
        [Browsable(true), Category("D"), Description("“新建文件夹”按钮是否显示在文件夹浏览对话框中"), DefaultValue(true)]
        public bool ShowNewFolderButton { get; set; }

        [Browsable(true), Category("D"), Description("对话框中在树视图控件上显示的说明文本"), DefaultValue("")]
        public string Description { get; set; }

        [Browsable(true), Category("D"), Description("从什么地方开始浏览的根文件夹，默认为 Desktop"), DefaultValue(Environment.SpecialFolder.Desktop)]
