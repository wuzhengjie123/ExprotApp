...
namespace D.Forms.Controls
{
    ...
    public sealed class MTabHeader : UserControl
    {
        ...
        [Browsable(true), Category("D"), Description("页卡下边线颜色")]
        ...
        [Browsable(true), Category("D"), Description("页卡下边线高度")]
        ...
        [Browsable(true), Category("D"), Description("激活选项卡颜色")]
        ...
        [Browsable(true), Category("D"), Description("默认选项卡颜色")]
        ...
        [Browsable(true), Category("D"), Description("是否双击关闭")]
        ...
        [Browsable(true), Category("D"), Description("是否始终显示关闭按钮，false状态下，仅鼠标悬浮时显示")]
        ...
        [Browsable(true), Category("D"), Description("分割线颜色")]
        ...
        /// 选中索引变更事件
        /// </summary>
        [Browsable(true), Category("D"), Description("选中索引变更事件")]
        public event Action<int> SelectedIndexChanged;

        [Browsable(true), Category("D"), Description("选项卡移除事件")]
