...
namespace D.Forms.Controls
{
    ...
    public class MDocking : Control
    {
        ...
        [Browsable(true), Category("D"), Description("停靠方向")]
        ...
        /// 停靠按钮的渐变颜色
        /// </summary>
        [Browsable(true), Category("D"), Description("停靠按钮的渐变颜色")]
        ...
        /// 停靠按钮的悬浮渐变颜色
        /// </summary>
        [Browsable(true), Category("D"), Description("停靠按钮的悬浮渐变颜色")]
        ...
        /// 停靠按钮的边框颜色
        /// </summary>
        [Browsable(true), Category("D"), Description("停靠按钮的边框颜色")]
        ...
        /// 停靠按钮的悬浮边框颜色
        /// </summary>
        [Browsable(true), Category("D"), Description("停靠按钮的悬浮边框颜色")]
