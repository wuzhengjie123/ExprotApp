...
namespace D.Forms
{
    ...
    public sealed class MBanner : UserControl
    {
        ...
        /// 切换频率
        /// </summary>
        [Browsable(true), Category("D"), Description("切换频率")]
        public int Interval { get { return this.timer.Interval; } set { this.timer.Interval = value; } }

        [Browsable(true), Category("D"), Description("图片动画展示方式")]
        ...
        {
            this.mPictureBox1 = new D.Forms.MPictureBox();
            ...
            this.mPictureBox1.Image = global::D.Forms.Properties.Resources.banner;
            this.mPictureBox1.ImageAnimation = D.Forms.ImageAnimation.None;
