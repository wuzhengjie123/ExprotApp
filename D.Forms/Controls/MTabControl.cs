...
namespace D.Forms
{
    ...
    {
        internal D.Forms.MBorderControl pnTitle;
        ...
        {
            return new D.Forms.ControlCollection(this);
        }
        ...
        [Browsable(true), Description("选项卡标题字体"), Category("D")]
        ...
        [Browsable(true), Description("选项卡标题下划线颜色"), Category("D")]
        ...
        [Browsable(true), Description("选项卡标题字体颜色"), Category("D")]
        ...
        [Browsable(true), Description("当前选项卡变更事件"), Category("D")]
        ...
        public int SelectedIndex
        {
            ...
            set
            {
                ...
                page.Selected = true;
                (this.Controls as D.Forms.ControlCollection).ChangeSelected(page, true);
