...
namespace D.Forms
{
    public sealed class MSuperTableControl : TabControl
    {
        ...
        [Browsable(true), Description("选项卡标题默认背景颜色"), Category("D")]
        ...
        [Browsable(true), Description("选项卡标题激活状态背景颜色"), Category("D")]
        ...
        [Browsable(true), Description("选项卡标题文字颜色"), Category("D")]
        ...
        [Browsable(true), Description("选项卡标题激活状态文字颜色"), Category("D")]
