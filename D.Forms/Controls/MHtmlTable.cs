...
namespace D.Forms
{
    public sealed class MHtmlTable : Control
    {
        ...
        [Localizable(true)]
        [Browsable(true), Category("D"), Description("表格列")]
