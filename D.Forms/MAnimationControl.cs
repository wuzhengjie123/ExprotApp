...
namespace D.Forms
{
    public class MAnimationControl : Component
    {
        ...
        [Browsable(true), Category("D"), Description("可见位置")]
        public Point VisibleLocation { get; set; }

        [Browsable(true), Category("D"), Description("停止位置，即隐藏位置")]
        public Point StopLocation { get; set; }

        [Browsable(true), Category("D"), Description("初始位置，即动画开始时处于位置")]
        public Point StartLocation { get; set; }

        /// <summary>
        /// 间隔/频率/速度
        /// </summary>
        [Browsable(true), Category("D"), Description("速度，毫秒"), DefaultValue(10)]
        ...
        /// 动画时长
        /// </summary>
        [Browsable(true), Category("D"), Description("动画时长，毫秒"), DefaultValue(500)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        ...
        [Browsable(true), Category("D"), Description("动画执行完成事件"), DefaultValue(500)]
