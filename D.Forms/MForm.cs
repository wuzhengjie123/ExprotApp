...
namespace D.Forms
{
    public class MForm : Form
    {
        ...
        [Browsable(true), Category("D"), Description("等待框字体")]
        public Font WaitingFont { get; set; }

        [Browsable(true), Category("D"), Description("是否显示窗体阴影效果")]
        ...
        [Browsable(true), Category("D"), Description("最大化到全屏")]
        public bool MaxToFullScreen { get; set; }

        [Browsable(true), Category("D"), Description("是否允许用户调整窗口大小")]
